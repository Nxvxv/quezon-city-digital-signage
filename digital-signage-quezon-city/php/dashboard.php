...
<html lang="en" class="h-full">
  ...
  <body class="h-full bg-gray-50 text-gray-900 font-montserrat">
    <div class="flex h-full">
      ...
      <aside class="w-64 bg-white border-r border-gray-200 flex flex-col">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
          <a
            href="#"
            id="tab-overview"
            class="flex items-center px-3 py-2 rounded-md text-primary bg-primary/20 hover:bg-primary/30"
          >
            <svg
              class="w-5 h-5 mr-2"
              fill="none"
          ...
          <a
            href="#"
            id="logout-btn"
            class="flex items-center px-3 py-2 rounded-md text-secondary hover:bg-gray-100"
          >
            <svg
              class="w-5 h-5 mr-2"
              fill="none"
        ...
        <div class="p-6 border-t border-gray-200 text-sm text-gray-500">
          ...
          <p
            id="branch-info"
            class="mt-1 font-semibold text-gray-700"
          >
            Main Branch
          </p>
        </div>
      ...
      <main class="flex-1 p-8 overflow-auto">
        ...
        <div class="mb-6 border border-gray-300 rounded bg-white flex overflow-hidden">
          <button
            id="tab-btn-overview"
            class="flex-1 py-2 px-4 bg-primary text-white flex items-center justify-center space-x-2"
          >
            <svg
              class="w-5 h-5"
              fill="none"
          ...
          <button
            id="tab-btn-videos"
            class="flex-1 py-2 px-4 flex items-center justify-center space-x-2 hover:bg-red-100 text-red-600"
          >
            <svg
              class="w-5 h-5"
              fill="none"
              ...
              viewBox="0 0 24 24"
            >
              <path d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14v-4zM4 6h10a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V8a2 2 0 012-2z" />
            </svg>
            <span>Videos</span>
          </button>
          <button
            id="tab-btn-announcements"
            class="flex-1 py-2 px-4 flex items-center justify-center space-x-2 hover:bg-blue-100 text-blue-600"
          >
            <svg
              class="w-5 h-5"
              fill="none"
          ...
          <button
            id="tab-btn-books"
            class="flex-1 py-2 px-4 flex items-center justify-center space-x-2 hover:bg-yellow-100 text-yellow-600"
          >
            <svg
              class="w-5 h-5"
              fill="none"
          ...
          <button
            id="tab-btn-footer"
            class="flex-1 py-2 px-4 flex items-center justify-center space-x-2 hover:bg-gray-200 text-gray-600"
          >
            <svg
              class="w-5 h-5"
              fill="none"
        ...
        <section
          ...
          class="tab-content bg-white p-6 rounded shadow"
        >
          ...
          <div class="bg-gray-50 p-4 rounded shadow">
            <p class="text-gray-900"
              >You are managing
              <span id="summary-videos">0 video(s)</span>,
              <span id="summary-announcements">0 announcement(s)</span>, and
              <span id="summary-books">0 book(s)</span> for this branch.</p
            >
            <p class="text-gray-900">
              Click on a category above to manage its content.
            </p>
          </div>
        </section>

        <section
          id="tab-videos-content"
          class="tab-content hidden bg-white p-6 rounded shadow"
        >
          <div class="flex justify-between items-center mb-4">
            <h3 class="text-lg font-semibold text-danger">Featured Videos</h3>
            <button
              id="upload-video-btn"
              class="bg-danger text-white px-4 py-2 rounded hover:bg-red-700"
            >
              Upload Video
            </button>
          </div>
          <form id="upload-video-form" class="mb-6 hidden space-y-4">
            <div>
              ...
              <input
                type="text"
                id="video-title"
                class="w-full border border-gray-300 rounded p-2 bg-white text-gray-900"
              />
            </div>
            <div>
              <label
            ...
            <div>
              ...
              <div class="flex space-x-2">
                <input
                  ...
                  id="video-duration"
                  min="1"
                  class="flex-1 border border-gray-300 rounded p-2 bg-white text-gray-900"
                />
                <select
                  id="video-duration-unit"
                  class="border border-gray-300 rounded p-2 bg-white text-gray-900"
                >
        ...
        >
          ...
          <form id="new-announcement-form" class="mb-6 hidden space-y-4">
            ...
            <div>
              <label
                for="announcement-text-size"
                class="block font-medium text-gray-700"
                >Text Size</label
              >
              <select
                id="announcement-text-size"
                class="w-full border border-gray-300 rounded p-2 bg-white text-gray-900"
              >
          ...
          <form id="new-footer-msg-form" class="mb-6 hidden space-y-4">
            ...
            <div>
              <label
                for="scroll-speed"
                class="block font-medium text-gray-700"
                >Scroll Speed: <span id="scroll-speed-value">50</span></label
              >
              <input
                type="range"
                id="scroll-speed"
    ...
    <div class="dashboard-footer">
      &copy; Created and Owned By Quezon City Government
    </div>
  </body>
</html>
